...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    final bool verificationType =
        ref.read(appSettingDataProvider.notifier).state.twoStepVerification;
            ...
            child: ListView(
              ...
              children: [
                ...
                FormBuilderTextField(
                  ...
                  style: AppTextStyle(context).bodyTextSmal,
                  decoration:
                      AppInputDecor(context).loginPageInputDecor2.copyWith(
                            isDense: true,
                    ...
                    onTap: () {
                      ...
                      if (_formkey.currentState != null &&
                        ...
                        ref
                            ...
                            .login(formData["mobile"], formData["password"]);
                      }
                  ...
                  Future.delayed(transissionDuration).then((value) {
                    ...
                    Future.delayed(buildDuration).then((value) {
                      ...
                      context.nav.pushNamedAndRemoveUntil(
                          Routes.bottomnavScreen, (route) => false);
                    });
                  });
