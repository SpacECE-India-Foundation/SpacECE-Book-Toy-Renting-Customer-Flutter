...
class _LoginOtpScreenState extends ConsumerState<LoginOtpScreen> {
  ...
  Widget build(BuildContext context) {
    final String verificationType =
        ref.read(appSettingDataProvider.notifier).state.deviceType;
      ...
      child: ListView(
        ...
        children: [
          ...
          Text(
            ...
            style:
                AppTextStyle(context).bodyText.copyWith(color: AppColor.gray),
          ),
          AppSpacerH(16.h),
          Row(
          ...
          otpTime == 0
              ? Align(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      ref.watch(forgotPassProvider.notifier).forgotPassword(
      ...
      child: AspectRatio(
        ...
        child: Center(
          child: TextField(
            ...
            style:
                AppTextStyle(context).bodyTextH1.copyWith(color: AppColor.blue),
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                  borderSide:
                      const BorderSide(width: 2, color: AppColor.offWhite),
                  borderRadius: BorderRadius.circular(4)),
              focusedBorder: OutlineInputBorder(
                borderSide: const BorderSide(width: 2, color: AppColor.blue),
                borderRadius: BorderRadius.circular(4),
              ),
            ),
          ),
