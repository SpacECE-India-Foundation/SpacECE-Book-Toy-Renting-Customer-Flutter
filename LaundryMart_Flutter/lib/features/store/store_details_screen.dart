                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style:
                                      AppTextStyle(context).bodyTextExtraSmall,
                                ),
                              ],
                            ),
                            AppSpacerH(6.h),
            ...
            child: Container(
              ...
              child: IndexedStack(
                ...
                children: [
                          ...
                          SizedBox(
                            child: Row(
                              ...
                              children: [
                                ...
                                //           style: AppTextDecor.regular12Black),
                                //     ),
                                //   ],
                                // ),
                  ...
                  ref.watch(allRatingsProvider(widget.store.id.toString())).map(
                        initial: (_) {
                          return const LoadingWidget();
                        },
                        loading: (_) {
                              ...
                              Expanded(
                                child: SizedBox(
                                  child: ListView.builder(
                                    padding: EdgeInsets.zero,
                                    shrinkWrap: true,
                                    itemCount: _.data.data!.ratings!.length,
