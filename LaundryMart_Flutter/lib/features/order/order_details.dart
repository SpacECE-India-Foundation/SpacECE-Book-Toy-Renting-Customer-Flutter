        ...
        ScreenWrapper(
          ...
          child: Column(
            children: [
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            child: Text(S.of(context).ordrdtls,
              ...
              ref.watch(orderDetailsProvider(widget.order.id.toString())).map(
                        ...
                        child: SizedBox(
                          child: ListView(
                            ...
                            children: [
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      SummaryContainer(
                                        ...
                                        amount:
                                            orderDetails.pickDate.toString(),
                                        style2: AppTextStyle(context)
                                            .bodyTextSmal
                                            .copyWith(
                                              color: AppColor.gray,
                              ...
                              AppSpacerH(8.h),
                              AddressContainer(
                                  change: false, address: customerAddress),
                              AppSpacerH(8.h),
...
class ExpandblePanelHeader extends StatelessWidget {
  const ExpandblePanelHeader({
    super.key,
    required this.isexapnded,
  });
