...
class _ShippingAndPaymentScreenState
  ...
  Widget build(BuildContext context) {
    final String currency =
        ref.read(appSettingDataProvider.notifier).state.currency;
    String storeId = Hive.box(AppHSC.appSettingsBox).get("storeid");
    ref.watch(orderOptionsProvider(storeId)).maybeWhen(
        loaded: (_) {
          deliver = double.parse(_.data!.deliveryCharge!);
        },
        orElse: () {});
            ...
            children: [
                    ...
                    children: [
                      ...
                      SizedBox(
                          ...
                          child: ref.watch(addresListProvider).map(
                              ...
                              loaded: (_) {
                                if (_.data.data!.addresses!.isNotEmpty) {
                                  addressid = _.data.data!.addresses!.first.id
                                      .toString();
                                  selectedAddressId = widget.address != null
                                      ? widget.address!.id.toString()
                                      : _.data.data!.addresses!.first.id
                                          .toString();
              ...
              ValueListenableBuilder(
                  ...
                  builder: (
                    ...
                    //     );
                    // end
                    total = AppGFunctions.calculateTotal(cartItems) -
                        ref.watch(discountAmountProvider) +
                        deliver;
                    return Container(
                            ...
                            Row(
                              children: [
                                ...
                                ref.watch(couponProvider).map(
                                  ...
                                  loaded: (_) {
                                    if (_.data.data?.coupon?.discount != null) {
                                      couponID = _.data.data?.coupon?.id;
                                      if (_.data.data?.coupon?.type!
                                              .toLowerCase() ==
                                          "percent".toLowerCase()) {
          ...
          child: ValueListenableBuilder(
            ...
            builder: (
              ...
              return Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16.h),
                  child: ref.watch(placeOrdersProvider).map(
                        initial: (_) {
                          return Column(
                            children: [
                              AppSpacerH(18.h),
                        ...
                        loaded: (_) {
                          Future.delayed(buildDuration).then(
                            (value) async {
                              final double amount = (calculateTotal(cartItems) -
                                  ref.watch(
                                    discountAmountProvider,
                                  ));
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    SummaryContainer(
                                                      type: S.of(context).ttl,
                                                      amount:
                                                          "$currency ${(amount + _.data.data!.order!.deliveryCharge!.toDouble()).toStringAsFixed(2)}",
                                                    ),
                                                    AppSpacerH(32.h),
                                                    AppIconButton(
                                                      onTap: () {
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          amount,
          style: style ??
              AppTextStyle(context).bodyTextSmal.copyWith(
                    color: AppColor.black,
                  ),
        )
      ],
      ...
      child: Container(
        ...
        child: Center(
          child: Text(
            ...
            style: AppTextStyle(context)
                .bodyTextExtraSmall
                .copyWith(color: textColor ?? AppColor.blue),
          ),
        ),
      ),
    );
